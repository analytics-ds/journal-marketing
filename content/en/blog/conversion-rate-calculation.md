---
title: "Conversion rate calculation: formula and method"
translationKey: "taux-conversion-calcul"
date: "2026-08-21"
lastmod: "2026-08-21"
description: "Conversion rate is calculated by dividing conversions by visitors, then multiplying by 100. Formula, examples and tools explained simply."
...
imageCredit: "Photo by Zuko.io Images via Wikimedia (CC BY 2.0)"
faq:
  ...
  - question: "What is the difference between conversion rate and transformation rate?"
    answer: "Both terms describe the same metric and follow the same formula. Transformation rate is the expression historically used in physical retail and direct sales, while conversion rate became standard with digital marketing and websites. No calculation difference separates them, only the context of use changes."
  - question: "How do I get the conversion rate of a website?"
    answer: "An analytics tool like Google Analytics 4 provides the conversion rate directly once conversion events are configured, a purchase, a completed form or a click on a key button. It is enough to divide the number of sessions that triggered this event by the total number of sessions over the period. Without a measurement tool, a manual calculation is still possible from the number of orders and the number of unique visitors."
  - question: "How do I measure the conversion rate of a physical store?"
    answer: "In a physical store, the number of visitors replaces web sessions and generally comes from a footfall counter installed at the entrance. The number of conversions corresponds to the receipts recorded over the same period. The formula stays identical: number of sales divided by number of visitors, multiplied by 100."
  - question: "What counts as a satisfactory conversion rate?"
    answer: "There is no universal threshold: conversion rate varies widely depending on the sector, the average basket price and the acquisition channel. Industry analyses generally place the e-commerce average around two to three percent, but a niche site with strong purchase intent can far exceed that level. The figure is most useful tracked over time and compared against a site's own history rather than an external average."
---
...
The number of visitors corresponds to the sessions recorded by the analytics tool over the chosen period. The number of conversions depends on the goal tracked, a purchase, an account creation or a submitted form, once the corresponding event is configured in the measurement tool. Agencies specialized in [web analytics](/en/blog/best-web-analytics-agencies/) often support this setup when several goals need to be tracked in parallel.
...
Writing quality also plays a direct role in conversion, especially on pages where the user has to decide, a product page, a landing page or a contact form. [Copywriting techniques](/en/blog/copywriting-techniques/) focused on persuasion help clarify the message and reduce hesitation at the moment of taking action.
...
Building a dedicated dashboard in [Looker Studio](/en/blog/looker-studio/) makes this reading easier by cross referencing conversion rate with acquisition sources, devices used or entry pages. This consolidated view avoids having to recalculate the metric manually at every performance review and highlights the segments that deserve priority attention.

## Frequently asked questions

<details>
<summary>How is conversion rate calculated?</summary>
Calculating conversion rate means dividing the number of conversions by the total number of visitors, then multiplying the result by 100 to get a percentage. A conversion can be a purchase, a newsletter signup or a quote request, depending on the goal set from the start. The result should always be read over a defined period, day, week or month, to stay comparable over time.
</details>

<details>
<summary>What is the difference between conversion rate and transformation rate?</summary>
Both terms describe the same metric and follow the same formula. Transformation rate is the expression historically used in physical retail and direct sales, while conversion rate became standard with digital marketing and websites. No calculation difference separates them, only the context of use changes.
</details>

<details>
<summary>How do I get the conversion rate of a website?</summary>
An analytics tool like Google Analytics 4 provides the conversion rate directly once conversion events are configured, a purchase, a completed form or a click on a key button. It is enough to divide the number of sessions that triggered this event by the total number of sessions over the period. Without a measurement tool, a manual calculation is still possible from the number of orders and the number of unique visitors.
</details>

<details>
<summary>How do I measure the conversion rate of a physical store?</summary>
In a physical store, the number of visitors replaces web sessions and generally comes from a footfall counter installed at the entrance. The number of conversions corresponds to the receipts recorded over the same period. The formula stays identical: number of sales divided by number of visitors, multiplied by 100.
</details>

<details>
<summary>What counts as a satisfactory conversion rate?</summary>
There is no universal threshold: conversion rate varies widely depending on the sector, the average basket price and the acquisition channel. Industry analyses generally place the e-commerce average around two to three percent, but a niche site with strong purchase intent can far exceed that level. The figure is most useful tracked over time and compared against a site's own history rather than an external average.
</details>
